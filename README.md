...
* In /src/main/webapp/viewAddCustomerOrder.jsp, change line 21 for cd.id to cd.clientId
* In /src/main/webapp/viewCustomerStockSuggestions.jsp, change line 11 for cd.id to cd.clientId